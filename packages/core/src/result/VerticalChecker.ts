...
export default class VerticalChecker implements ResultChecker {
  check(board: Board): GameResult {
    const coluna0: [number, number][] = [[0, 0], [0, 1], [0, 2]] //* posições da Coluna0
    const coluna1: [number, number][] = [[1, 0], [1, 1], [1, 2]] //* posições da Coluna1
    const coluna2: [number, number][] = [[2, 0], [2, 1], [2, 2]] //* posições da Coluna2
    const finalResult = [
